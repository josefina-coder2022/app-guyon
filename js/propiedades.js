...
// VARIABLE DE LAS PROPIEDADES EN EL SESSION STORAGE
let propiedadesStorage = [];

// VARIABLES PARA BUSCAR UN INMUEBLE QUE ESTA EN EL ARRAY
...
const mostrarPropiedades = async () => {
    ...
    try {
        ...
        htmlCode = htmlCode + '<div class="clearfix"></div>'; //Borra rápida y fácilmente el contenido flotante dentro de un contenedor agregando la utilidad clearfix
